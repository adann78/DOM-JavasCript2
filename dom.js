...
let texto = "¿Quien conquistó tenochtitlan?";
...
console.log($linkDOM.dataset.description);
$linkDOM.dataset.description = "Suscríbete a mi cannal y descomparte";
console.log($linkDOM.dataset.description);
console.log($linkDOM.hasAttribute("data-id"));
$linkDOM.removeAttribute("data-id");
console.log($linkDOM.hasAttribute("data-id")); 
$linkDOM.setAttribute("data-description", "Modelo de Objet del Documento");
$linkDOM.dataset.description = "Suscríbete a mi cannal y ...";
...
let varDarkColor = getComputedStyle($html).getPropertyValue("--dark-color"),
  ...
  varCyanColor = getComputedStyle($html).getPropertyValue("--medium-color");
...
$elemento.innerHTML = text;
 $elemento2 = document.getElementById("el2");
 $elemento2.innerHTML = "Hola Adan";
*/
...
$figure2.innerHTML = `
<img src="https://picsum.photos/id/219/200/300" alt="Animal">
...
$newCard.innerHTML = `
  <img src="https://picsum.photos/id/45/200/300" alt="Any">
